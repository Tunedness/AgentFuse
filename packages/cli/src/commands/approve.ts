...
export function approveHelp(): string[] {
  return [
    ...
    '  --reason, -r <why>    Required. Recorded in the wrap’s log, in the trip',
    '                        report, and in `agentfuse report` output — the',
    '                        report is an audit artefact, and "why was this',
    '                        call allowed" is what an audit asks.',
...
export function denyHelp(): string[] {
  return [
    ...
    '  <approval id>         The id from the pending prompt.',
    '  --reason, -r <why>    Required. Recorded in the wrap’s log, in the trip',
    '                        report, and — for a denial — in the refusal the',
    '                        agent reads, attributed to you: "A human denied',
    '                        this call. Reason given: ...". Write it for both',
    '                        audiences.',
